...
SPARK_RX_MCAST=239.255.194.137 SPARK_RX_PORT=16388 SPARK_RX_SRC=${BMD1_IP:-192.168.18.104}
SPARK_IN_W=1920 SPARK_IN_H=1080 SPARK_IN_FPS=30000/1001 SPARK_IP10=0
SPARK_TX_PCI=0002:01:00.0 SPARK_TX_SRC=192.168.18.103 SPARK_TX_MCAST=239.100.0.10
