...
//   sudo -n SPARK_TX_PCI=0000:01:00.0 SPARK_DST_MAC=30:c5:99:3e:9d:2c \   # the generator -> port B
...
class St2110Passthrough : public holoscan::Application {
 public:
  void compose() override {
    ...
    const std::string dst_mac = env("SPARK_DST_MAC", "30:c5:99:3e:9d:30");    // port D (0002:01:00.1)
